...
from .views import (
    FindScheduleRedirectView,
    LessonCompleteView,
    LessonConfirmView,
    LessonDetailView,
    LessonEditAfterComplete,
    LessonListView,
    LessonCreateView,
    LessonDeleteView,
    LessonMarkAsPaidView,
    LessonSplit,
    LessonStartView,
    LessonUpdateView,
)
...
urlpatterns = [
    ...
    path(
        '<int:pk>/edit/', login_required(LessonUpdateView.as_view()), name='lesson-edit'
    ),
    path(
        '<int:pk>/detail/',
    ...
    path(
        '<int:pk>/setInProgress/',
        login_required(LessonStartView.as_view()),
        name='lesson-set-in-progress',
    ),
    path(
        '<int:pk>/confirm/',
        login_required(LessonConfirmView.as_view()),
        name='lesson-confirm',
    ),
    path(
        '<int:pk>/split/',
        login_required(LessonSplit.as_view()),
        name='lesson-split',
    ),
    path(
        '<int:pk>/complete/',
        login_required(LessonCompleteView.as_view()),
        name='lesson-complete',
    ),
    path(
        '<int:pk>/edit-after-complete/',
        login_required(LessonEditAfterComplete.as_view()),
        name='lesson-edit-after-complete',
    ),
    path(
        '<int:pk>/markAsPaid/',
        login_required(LessonMarkAsPaidView.as_view()),
